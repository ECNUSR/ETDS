...
def main():
    ...
    convert_model('/tmp/base/base', 'experiments/test_times/ops/base/base.tflite', 2, input_channel=3, time=True)

    # to int8 tflite
    convert_model('/tmp/base/base', 'experiments/test_times/ops/base/int8/base.tflite', 2, input_channel=3, mode='int8', time=True)
