...
def main():
    ...
    os.makedirs('experiments/test_times/ops/prelu', exist_ok=True)
    os.makedirs('experiments/test_times/ops/prelu/int8', exist_ok=True)

    # to tflite
    model.save('/tmp/prelu/prelu', overwrite=True, include_optimizer=True, save_format='tf')
    convert_model('/tmp/prelu/prelu', 'experiments/test_times/ops/prelu/prelu.tflite', 2, input_channel=3, time=True)

    # to int8 tflite
    convert_model('/tmp/prelu/prelu', 'experiments/test_times/ops/prelu/int8/prelu.tflite', 2, input_channel=3, mode='int8', time=True)
